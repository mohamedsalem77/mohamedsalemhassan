...
$product = new Product;
$newestProducts = $product->getMostRecentProducts()->fetch_all(MYSQLI_ASSOC);
$mostOrderedProducts = $product->getMostOrderedProducts()->fetch_all(MYSQLI_ASSOC);
                        ...
                        <div class="product-wrapper mb-30">
                            <div class="product-img">
                                <a href="product-details.php?product=<?= $product['id']?>">
                                    <img alt="" class="w-100" src="assets/img/product/<?= $product['image']?>">
                                </a>
